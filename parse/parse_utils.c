...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/19 20:18:53 by udemirci          #+#    #+#             */
/*   Updated: 2025/08/20 00:34:43 by udemirci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	handle_quotes(char current_char, char *quote_flag, char *output,
		int *j)
{
	if ((current_char == '\'' || current_char == '"') && (*quote_flag == 0
